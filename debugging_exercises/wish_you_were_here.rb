...
class GeoLocation
  ...
  def ==(other) # SOLUTION - need to define a == method or else BasicObject#== will be invoked,
    # which only tells you if both objects are the same exact object (same object id)
