...
# are testing our program, an exception is raised.
...
class Employee
  ...
  protected # SOLUTION - == method called serial_number getter on another
  # Employee object. We cant call private methods with explicit callers,
  # so we need to make the getter method a protected one so that it is
