...
# of the class attempt to access the secret data.
...
# logging class. The logging class has been supplied to
...
# vehicle into their system - a Catamaran defined as follows:
class Catamaran
...
class Catamaran < Vehicle
  ...
  def initialize(num_propellers, num_hulls, km_traveled_per_liter, liters_of_fuel_capacity)
    ...
    @num_hulls = num_hulls
    super(km_traveled_per_liter, fuel_capacity)
  end
end
